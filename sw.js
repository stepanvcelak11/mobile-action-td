...
const MODULES = ['src/achievements.js', 'src/army.js', 'src/audio.js', 'src/battlemarks.js', 'src/bunker.js', 'src/campaign.js', 'src/clip.js', 'src/config.js', 'src/daily.js', 'src/effects.js', 'src/entities.js', 'src/errors.js', 'src/i18n.js', 'src/icons.js', 'src/installhint.js', 'src/lang-cs.js', 'src/main.js', 'src/merge.js', 'src/meta.js', 'src/minimap.js', 'src/models.js', 'src/music.js', 'src/perf.js', 'src/perfreport.js', 'src/portraits.js', 'src/post.js', 'src/powers.js', 'src/progress.js', 'src/roguelite.js', 'src/showcase.js', 'src/skill.js', 'src/skinfx.js', 'src/trees.js', 'src/treeview.js', 'src/ui.js', 'src/viewport.js', 'src/voice.js', 'src/world.js'];
