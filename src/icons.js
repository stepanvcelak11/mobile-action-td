...
export function turretIcon(type) {
  ...
  const heads = {
    ...
    minelayer: `<rect x="14" y="22" width="20" height="9" rx="2" fill="#9aa6b2"/><rect x="18" y="12" width="12" height="11" rx="2" fill="${steel}"/><ellipse cx="11" cy="37" rx="6" ry="2.5" fill="${dark}"/><circle cx="11" cy="35" r="2" fill="${c}"/><ellipse cx="37" cy="40" rx="6" ry="2.5" fill="${dark}"/><circle cx="37" cy="38" r="2" fill="${c}"/><path d="M26 4l-4 6h4l-4 6" stroke="${c}" stroke-width="2" fill="none"/>`,
